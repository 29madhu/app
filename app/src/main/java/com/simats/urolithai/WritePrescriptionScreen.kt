    ...
    Scaffold(
        ...
        bottomBar = {
            Row(
                ...
                Button(
                    ...
                    Icon(painter = painterResource(id = R.drawable.send), contentDescription = "Preview & Send", tint = Color.White)
                    Spacer(modifier = Modifier.width(8.dp))
                    Text("Preview & Send")
                }
            }
        ...
        Column(
            ...
            Row(
                ...
                TextButton(onClick = { /* TODO: Add new medication field */ }) {
                    Text("+ Add")
                }
            }
            OutlinedTextField(
            ...
            // Notes / Advice
            Text("Notes / Advice", fontWeight = FontWeight.Bold)
            OutlinedTextField(
                value = notes,
...
@Composable
fun WritePrescriptionScreenPreview() {
    UroLithAITheme {
        WritePrescriptionScreen(rememberNavController())
    }
}
